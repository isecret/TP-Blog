...
<body>
  ...
  <div class="header-main">
    ...
    <nav>
      ...
      <span class="nav-child"><a href="?a=archives">Archives</a></span>
      <span class="nav-child"><a href="<?php echo U('About/index');?>">About</a></span>
      <span class="nav-child"><a href="<?php echo U('Link/index');?>">Links</a></span>
        ...
        <footer>
      <span class="footer-copy">Copyright 2016-2017 <i class="fa fa-heart" style="color: tomato;"></i> Secret | <a href="#">Login</a> | Powered by <a href="#">Hi</a></span>
    </footer>
    </main>
