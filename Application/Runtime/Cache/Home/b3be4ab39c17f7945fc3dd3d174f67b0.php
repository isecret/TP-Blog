		...
		<content>
			<article>
				...
				<div class="article-content-container">
					<ul class="links">
						<?php if(is_array($links)): foreach($links as $key=>$link): ?><li class="links-items">
							<a href="<?php echo ($link["url"]); ?>">
								<img class="links-avatar" src="<?php echo ($link["avatar"]); ?>" alt="">
								<span class="links-name"><?php echo ($link["name"]); ?></span>
							</a>
