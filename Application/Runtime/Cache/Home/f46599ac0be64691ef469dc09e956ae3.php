  ...
  <div class="header-main">
    ...
    <nav>
      ...
      <span class="nav-child"><a href="<?php echo U('Link/index');?>">Links</a></span>
		...
		<script src="/Public/js/gitment.browser.min.js"></script>
		<script>
		var gitment = new Gitment({
		  id: window.location.pathname.replace(/(\/$)/g, ''),
		  owner: '<?php echo C("GITHUB_ID");?>',
		  repo: '<?php echo C("GITHUB_REPO");?>',
		  oauth: {
		    client_id: '<?php echo C("GITHUB_CLIENT_ID");?>',
		    client_secret: '<?php echo C("GITHUB_CLICENT_SECRET");?>',
		  },
		});
