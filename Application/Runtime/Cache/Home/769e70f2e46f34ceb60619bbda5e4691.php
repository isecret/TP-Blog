  ...
  <div class="header-main">
    ...
    <nav>
      ...
      <span class="nav-child"><a href="<?php echo U('Link/index');?>">Links</a></span>
		...
		<content>
			<?php if(isset($categoryTitle)): ?><span class="category-title">关于 <?php echo ($categoryTitle); ?> 的分类</span><?php endif; ?>
			<?php if(is_array($articles)): foreach($articles as $key=>$article): ?><article>
					<div class="article-title-container">
						...
						<span class="article-info"><?php echo (date("F d, Y", $article["created_at"])); ?> · <a href="#"><?php echo ($article["category"]); ?></a></span>
					</div>
